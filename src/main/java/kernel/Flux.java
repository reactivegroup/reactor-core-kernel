 ...
 *
 * <p> {@link #subscribe(reactor.core.CoreSubscriber)} is an internal extension to
 ...
 * @see Mono
 */
public abstract class Flux<T> implements reactor.core.CorePublisher<T> {
...
//	 ==============================================================================================================
     ...
     * @see #push(Consumer)
     */
    public static <T> Flux<T> create(Consumer<? super reactor.core.publisher.FluxSink<T>> emitter) {
     ...
     */
    public static <T> Flux<T> create(Consumer<? super reactor.core.publisher.FluxSink<T>> emitter, OverflowStrategy backpressure) {
     ...
     * @see #create(Consumer)
     */
    public static <T> Flux<T> push(Consumer<? super reactor.core.publisher.FluxSink<T>> emitter) {
     ...
     * {@link #subscribe(Subscriber)} with a {@link reactor.core.publisher.BaseSubscriber}.
     * <p>
    ...
    public final void subscribe(Subscriber<? super T> actual) {
        ...
        reactor.core.CoreSubscriber subscriber = Operators.toCoreSubscriber(actual);
