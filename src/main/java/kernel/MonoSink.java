...
public interface MonoSink<T> {
	...
	/**
	 * Complete this {@link reactor.core.publisher.Mono} with the given value.
	 ...
	 * <p>
	 *   {@link Context} can be enriched via {@link reactor.core.publisher.Mono#contextWrite(Function)}
